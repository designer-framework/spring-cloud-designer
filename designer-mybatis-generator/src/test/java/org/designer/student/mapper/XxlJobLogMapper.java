...
public interface XxlJobLogMapper extends BaseMapper<Long, XxlJobLog> {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default int deleteBatchByPrimaryKeys(Collection<Long> ids) {
        return delete(
            org.mybatis.dynamic.sql.SqlBuilder.deleteFrom(xxlJobLog)
                .where(id, isIn(ids))
                .build()
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default UpdateDSL<UpdateModel> updateAllColumns(XxlJobLog record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    default UpdateDSL<UpdateModel> updateSelectiveColumns(XxlJobLog record, UpdateDSL<UpdateModel> dsl) {
